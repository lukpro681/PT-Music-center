...
# Template: app
# Command: G:\Qt\5.15.2\mingw81_64\bin\qmake.exe -o Makefile MusicCenter.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: MusicCenter.pro G:/Qt/5.15.2/mingw81_64/mkspecs/win32-g++/qmake.conf G:/Qt/5.15.2/mingw81_64/mkspecs/features/spec_pre.prf \
		...
		G:/Qt/5.15.2/mingw81_64/mkspecs/features/qml_debug.prf \
